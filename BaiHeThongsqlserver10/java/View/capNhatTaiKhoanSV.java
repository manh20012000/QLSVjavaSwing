...
public class capNhatTaiKhoanSV extends JPanel {
	...
	public void capnhat() {
		  String matkhauCu=doiTaiKhoanSV.updateDoiTaiKhoan().matKhauCu(txtNhpVoTn.getText());
	      if(txtNhpVoTn.getText().equals("")||pasDn.getText().equals("")||pasDn2.getText().equals("")) {
	    	 ...
	    	 int gtri1=JOptionPane.showConfirmDialog(this,"cập nhật thành công");
 		     if(gtri1==JOptionPane.YES_OPTION) {
 		    	doiTaiKhoanSV.updateDoiTaiKhoan().doimatkhau(pasDn2.getText(), txtNhpVoTn.getText());
 			    txtNhpVoTn.setText("");
 	            pasDn.setText("");
 	            pasDn2.setText("");
 	           return ;	
