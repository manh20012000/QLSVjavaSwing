		...
		add(cbxhocky);
		 ...
		 cbxlop.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		...
		 		System.out.println("comboboxmalop"+lop);
...
//	}
	...
	public void capnhat() {
		ConnectDanhgiaRL.danhgia().upDatedanhgiaRenluyen(Float.parseFloat(textField_1.getText()), cbxhanhkiem.getSelectedItem()+"",textField_5.getText(),lbelMasv.getText());
		DefaultTableModel model=(DefaultTableModel)table.getModel();
			while(true) {
				/* xóa toàn bộ dữ liệu trong tabel cho đến khi hết thì thôi*/
