...
public class DiemDanh extends JPanel {
	...
	public DiemDanh() {
		...
		scrollPane_1.setBounds(10, 90, 1061, 402);
		add(scrollPane_1);
		table_2 = new JTable();
		...
		cbbhocky.addItem("hk1:2023-2024");
		cbbhocky.addItem("hk2:2023-2024");
		cbbhocky.addItem("hk1:2024-2025");
		cbbhocky.addItem("hk2:2024-2025");
		cbbhocky.addItem("hk1:2025-2026");
		cbbhocky.addItem("hk2:2025-2026");
	...
	public  void DanhDauDiemDanh() throws Exception{
		try {
			DefaultTableModel model=(DefaultTableModel)table_2.getModel();
