    ...
    public int CreateTableLogin() {
        try {
            ...
            String sql = "CREATE TABLE QUANLYSINHVIEN"
            		...
            		+ "   GHICHU NVARCHAR(50)"
            		+ ")"
            		+ "insert into  TAIKHOANNHATRUONG values('1234567',12345000)";
  ...
  public int creatrTriger() {
	try { 
	    ...
	    String sql = "CREATE TRIGGER Capnhat_diemdanh ON PHANTRAM"
	    		...
	    		+ "	 	   END"
	    		+ "go"
	    		+ "ALTER trigger [dbo].[capnhatThanhToan] on [dbo].[THANHTOAN]\r\n"
	    		+ "FOR UPDATE,INSERT,DELETE\r\n"
	    		+ "  AS \r\n"
	    		+ "  BEGIN\r\n"
	    		+ "		update TAIKHOANNHATRUONG\r\n"
	    		+ "		set money = (SELECT SUM(TONGTHANHTOAN) FROM THANHTOAN where THANHTOAN.MASOTAIKHOAN = TAIKHOANNHATRUONG.MASOTAIKHOAN)\r\n"
	    		+ " 	                                      \r\n"
	    		+ "  END";
