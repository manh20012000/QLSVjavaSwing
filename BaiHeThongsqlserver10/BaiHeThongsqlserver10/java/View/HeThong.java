...
public class HeThong extends JFrame {
	...
	inforsinhvien infsv;
        public HeThong() {
            ql=new Quanly(layeredPaneht);
            qlht=new quanlyht(layeredPaneht);
            infsv=new inforsinhvien(layeredPaneht);
        	setAlwaysOnTop(true);
        	...
        	login.layeredPane.setSize(474, 475);
        	login.layeredPane.setLocation(530, 48);
